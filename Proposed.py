...
# Developed Coronavirus Mask Protection Algorithm (CMPA) -> Updatation done in line no 51
...
def Proposed(values, objective_function, xmin, xmax, maximum_iterations):
    ...
    for iteration in range(maximum_iterations):
        ...
        # Perform mutation
        mask = (best_fitness * fitness_scores[iteration])/(max(fitness_scores) * fitness_scores[iteration]) < mutation_rate
